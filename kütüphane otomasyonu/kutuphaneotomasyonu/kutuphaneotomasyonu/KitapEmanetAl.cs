...
namespace kutuphaneotomasyonu
{
    public partial class KitapEmanetAl : Form
    {
        ...
        private void btn_emanetal_Click(object sender, EventArgs e)
        {
            ...
            // İstenilen kitap var mı kontrol sorgusu
            ...
            if(kontrol.ExecuteScalar() != null)// null değilse var
            {
                // Kitabın adet bilgisini sorgulama
                ...
                if(int.Parse(kontrol2.ExecuteScalar().ToString()) == 0)// adet 0 ise olan kitapları başkası almıştır
                {
                    MessageBox.Show("Malesef bu kitap kütüphanede yok","Bilgi",MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else // Kitap vardır
                {
                    //emanet kitaplar tablosuna eklenir
                    ...
                    if (result == 1)
                    {
                        //emanet alındıktan sonra kitap adeti 1 azaltılır
            ...
            else // null ise kitap kütüphanede yok
        ...
        public void datagriedwieveyazdirma() // kütüphanedeki kitapları datagridviewe yazdırma
        {
            baglanti.Open();
