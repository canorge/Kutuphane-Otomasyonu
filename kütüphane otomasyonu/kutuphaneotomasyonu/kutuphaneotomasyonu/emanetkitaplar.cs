...
namespace kutuphaneotomasyonu
{
    public partial class emanetkitaplar : Form
    {
        ...
        private void emanetkitaplar_Load(object sender, EventArgs e)//emanet kitapları gösterme
        {
            // emanet kitapları datagridviewe yazdırma
            baglanti.Open();
            SqlCommand cmd = new SqlCommand("select * from emnaetkitaplar", baglanti);
